<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SCRF_Post.aspx.cs" Inherits="CSRFDemo.解决方案.SCRF_Post" %>
...
<body onload="document.getElementById('form1').submit()">
    ...
    <form id="form1" method="post" action="/解决方案/Post2.aspx" style="display: none;">
        <div>
